...
Mots-clés cœur : *premier tour*, *présidentielle 2027*, *pluralité électorale*, *open data élections*, *La démocratie avant l’élimination*, *LMDPT*.
...
| # | Action | Preuve |
|---|--------|--------|
| 1 | Google Search Console — propriété `lmdpt.iarbre.org` + soumettre **sitemap-index.xml** | GSC |
...
| 6 | **Tous les outils Google gratuits** — checklist complète | [`docs/GOOGLE-SEO.md`](./GOOGLE-SEO.md) |
